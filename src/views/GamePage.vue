  ...
  <div class="w-100 container">
    ...
    <div class="d-flex justify-content-center mt-5">
      <div class="w-100 d-flex justify-content-around">
        <b-card tag="article" class="mb-2 mx-1 w-100">
          <h4 class="border-bottom text-center">{{ username }}</h4>
          <h4 class="border-bottom text-center">Your Score :</h4>
          <h4 class="mt-3 text-center">{{ score }}</h4>
        </b-card>
      </div>
    </div>
  </div>
